...
class GenericFunctions extends CApplicationComponent{ 
	...
	public static function renderImg($nombre){

		return $nombre."_".Yii::app()->params['screen'].".jpg";
    ...
    public function setVariableSession($varsession){
    	...
    	if(!isset($varsession) || empty($varsession) || $varsession==""){
			...
			$_SESSION['error']=Yii::t("global","Variable de session no definida en setVariableSession");
